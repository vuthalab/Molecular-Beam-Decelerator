...
ax.grid()
ax.plot(x*1e3, gxfullfield(x,0,0))
...
ax = fig.add_subplot(111)
ax.grid()
ax.plot(y*1e3, gyfullfield(0,y,0))
...
ax = fig.add_subplot(111)
ax.grid()
ax.plot(z*1e3, gzfullfield(0,0,z))
ax.set_title('GradB_z vs z')
ax.set_xlabel("z [mm]")
ax.set_ylabel("dB/dz [T]")

fig = plt.figure()
ax = fig.add_subplot(111)
ax.grid()
ax.plot(z*1e3, fullfield(0,0,z))
ax.set_title('B_z vs z')
ax.set_xlabel("z [mm]")
ax.set_ylabel("B [T]")

#%% PLOT OF A SHIFT IN THE MAGNETIC FIELD ALONG POSITION
fig = plt.figure()
ax = fig.add_subplot(111)
ax.grid()
ax.plot(z*1e3, fullfield(0,0,z))
...
ax = fig.add_subplot(111)
ax.grid()
ax.plot(z*1e3+10, fullfield(0,0,z))
ax.set_title('B_z vs z')
ax.set_xlabel("z [mm]")
ax.set_ylabel("B [T]")
...
def equation_system(b,t):
    ...
    db_over_dt = [vxt,vyt,vzt, B_str*mol_state(xt,yt,zt)*gxfullfield(xt,yt,zt%(20*mm),1), B_str*mol_state(xt,yt,zt)*gyfullfield(xt,yt,zt%(20*mm),1), B_str*mol_state(xt,yt,zt)*gzfullfield(xt,yt,zt%(20*mm),1)]
    return db_over_dt
